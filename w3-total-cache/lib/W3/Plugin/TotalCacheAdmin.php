...
class W3_Plugin_TotalCacheAdmin extends W3_Plugin {
    ...
    function admin_enqueue_scripts() {
        wp_register_style('w3tc-options', plugins_url('w3-total-cache/pub/css/options.css', W3TC_FILE), array(), W3TC_VERSION);
        wp_register_style('w3tc-lightbox', plugins_url('w3-total-cache/pub/css/lightbox.css', W3TC_FILE), array(), W3TC_VERSION);
        wp_register_style('w3tc-widget', plugins_url('w3-total-cache/pub/css/widget.css', W3TC_FILE), array(), W3TC_VERSION);

        wp_register_script('w3tc-metadata', plugins_url('w3-total-cache/pub/js/metadata.js', W3TC_FILE), array(), W3TC_VERSION);
        wp_register_script('w3tc-options', plugins_url('w3-total-cache/pub/js/options.js', W3TC_FILE), array(), W3TC_VERSION);
        wp_register_script('w3tc-lightbox', plugins_url('w3-total-cache/pub/js/lightbox.js', W3TC_FILE), array(), W3TC_VERSION);
        wp_register_script('w3tc-widget', plugins_url('w3-total-cache/pub/js/widget.js', W3TC_FILE), array(), W3TC_VERSION);
        wp_register_script('jquery-masonry', plugins_url('w3-total-cache/pub/js/jquery.masonry.min.js', W3TC_FILE), array('jquery'), W3TC_VERSION);
    }
...
<script type="text/javascript">
    ...
    <style type="text/css" media="screen">
        #toplevel_page_w3tc_dashboard .wp-menu-image {
            background: url(<?php echo plugins_url('wpoven-manager/w3-total-cache/pub/img/w3tc-sprite.png')?>) no-repeat 0 -32px !important;
        }
        ...
        #icon-edit.icon32-posts-casestudy {
            background: url(<?php echo plugins_url('wpoven-manager/w3-total-cache/pub/img/w3tc-sprite.png') ?>) no-repeat;
        }
        /**
        * HiDPI Displays
        */
        ...
        (min-resolution: 120dpi) {
            ...
            #toplevel_page_w3tc_dashboard .wp-menu-image {
                background-image: url(<?php echo plugins_url('wpoven-manager/w3-total-cache/pub/img/w3tc-sprite-retina.png')?>) !important;
